...
#define focusSpeedMax 0.10//lower is faster
...
#define SUMMONER_VIEWER_BACKGROUND "assets/summonerViewerBackground.png"
#define SUMMONER_VIEWER_BACKGROUND_INDEX 148
#define SUMMONER_VIEWER_BACKGROUND_HEIGHT 1180
#define SUMMONER_VIEWER_BACKGROUND_WIDTH 358
