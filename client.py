...
#                uiElements.viewer.theViewer = uiElements.unitViewer(node)
    ...
    def startSummoning(args):
        ...
        gameState.getGameMode().players[node.unit.player].greenWood = gameState.getGameMode().players[node.unit.player].greenWood - (gameState.researchProgress[node.unit.player][unitType][0]*unitType.costGreen)
