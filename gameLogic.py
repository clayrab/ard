...
class unitType:
	def __init__(self,name,textureIndex,movementSpeed,attackSpeed,attackPower,range,health,canFly,canSwim,cost,buildTime,movementSpeedBonus,attackSpeedBonus,attackPowerBonus):
		self.name = name
